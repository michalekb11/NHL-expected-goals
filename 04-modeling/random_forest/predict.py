...
model_path = f'./04-modeling/random_forest/models/{model_name}.pkl'
...
test_index, test_features, test_targets = prep_for_forest(test_df, index_cols=index_cols, target_col=target_col)
...
test_preds = rf.predict_proba(test_features)[:,1]
